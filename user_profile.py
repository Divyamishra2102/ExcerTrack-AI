...
def dashboard():
	...
	kneer = Button(des, text= "Standing Knee Raise",height=2, width=50, command=kneeraise)
	kneer.place(x=220, y=240)
...
def signup():
	...
	winsignup = Tk()
	winsignup.title("ExcerTrack AI App")
